...
/**
 * @typedef {{ reference: ComponentReference, count: number }} ComponentReferenceEvent
 * @typedef {{
...
export class ComponentReference extends Watchable {
    ...
    /**
     * @param {{ entity: string, type: string, owner?: string }} referer
...
export class ComponentReferenceSet extends Watchable {
    ...
    create(referer, { entity, type }) {
        ...
        this.notify(`reference:add`,                   { reference, count: this.#set.size                               });
        this.notify(`reference:add:${entity}`,         { reference, count: this.#byEntity.count(entity)                 });
        this.notify(`reference:add:${entity}:${type}`, { reference, count: this.#byComponent.count(`${entity}:${type}`) });
    ...
    #release(reference) {
        ...
        this.notify(`reference:release:${entity}`,         { reference, count: this.#byEntity.count(entity)                 });
        this.notify(`reference:release:${entity}:${type}`, { reference, count: this.#byComponent.count(`${entity}:${type}`) });
    }
