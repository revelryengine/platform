 ...
 * @import { System, SystemConstructor } from './system.d.ts';
 * @import { Model, ModelConstructor   } from './model.d.ts';
 * @import { SystemContexts, SystemContextKey, SystemBundle, StageFile } from './ecs.d.ts';
 * @import { ComponentDataMapSerialized, ComponentValueTypeMapSerialized } from './ecs.d.ts';
 */
...
export class Stage extends Watchable {
    ...
    #cleanupModel(ModelClass, entity) {
        const modelSet = this.#modelsByClass.get(ModelClass);
        if(modelSet) {
            modelSet.delete(entity);
            if(!modelSet.size) {
