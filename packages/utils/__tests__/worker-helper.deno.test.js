...
import { WorkerHelper } from '../worker-helper.js';
...
describe('WorkerHelper', () => {
    describe('type=undefined', () => {
        it('throws if classic worker not supported in environment', async () => {
            const helper = new WorkerHelper(import.meta.resolve('./__fixtures__/worker.js'));
    ...
    describe('type=class', () => {
        it('throws if classic worker not supported in environment', async () => {
            const helper = new WorkerHelper(import.meta.resolve('./__fixtures__/worker.js'), { type: 'classic' });
