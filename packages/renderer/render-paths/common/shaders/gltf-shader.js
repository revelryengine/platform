...
import { NonNull, normalizers, WeakCache } from 'revelryengine/utils/utils.js';
...
export class GLTFShader extends Shader {
    ...
    getFlags() {
        const { primitive, material, frontFace, renderNode: { alpha, settings } } = this.input;

        const flags = {
            frontFace,

            hasAttr           : /** @type {Record<import('revelryengine/gltf/gltf.js').AttributeName, boolean>} */(Object.fromEntries(Object.entries(primitive.attributes).map(([name, value]) => [name, !!value]))),
            ...
            hasTarget         : primitive.targets?.reduce((accum, target) => {
                for(const attr in primitive.attributes) {
                    if(attr in target) accum[/** @type {import('revelryengine/gltf/gltf.js').TargetName} */(attr)] = true;
                }
                return accum;
            }, /** @type {Record<import('revelryengine/gltf/gltf.js').TargetName, boolean>} */({})),
            ...
            colorTargets: /** @type {{ color?: boolean, blend?: boolean, motion?: boolean, point?: boolean, id?: boolean, accum?: boolean, reveal?: boolean }} */({
                color:  true,
                blend:  settings.flags.alphaBlendMode === 'weighted' && alpha,
    ...
    getLocations() {
        ...
        const locations = {
            attr:     /** @type {Record<import('revelryengine/gltf/gltf.js').AttributeName, number>} */({}),
            textures: /** @type {Record<keyof import('../../../material.js').TexturesList, number>} */({}),
            targets:  /** @type {Record<import('revelryengine/gltf/gltf.js').TargetName, number>} */({}),
            target:    0,
            material:  0,
        ...
        for(const [name, value] of Object.entries(flags.hasAttr)) {
            if(value) locations.attr[/** @type {import('revelryengine/gltf/gltf.js').AttributeName} */(name)] = attrLoc++;
        }
    ...
    #createAttributeBuffers() {
        ...
        const buffers = {
            ...
            attrs: /** @type {Record<keyof import('revelryengine/gltf/gltf.js').MeshPrimitive['attributes'], BufferInfo>} */({})
        }
        const { indices } = primitive;

        for (const n of Object.keys(locations.attr)) {
            const name = /** @type {keyof import('revelryengine/gltf/gltf.js').MeshPrimitive['attributes']} */(n)
    ...
    /**
     * @param {import('revelryengine/gltf/gltf.js').Accessor} indices
     * @param {import('revelryengine/gltf/gltf.js').Accessor} accessor
     */
    ...
    /**
     * @param {{
     *  accessor: import('revelryengine/gltf/gltf.js').Accessor,
     *  usage:    import('../../../constants.js').BUFFER_USAGE,
     *  name:     string,
     *  deindex?: boolean,
     *  indices?: import('revelryengine/gltf/gltf.js').Accessor
     * }} options
     */
    ...
    /**
     * @param {{ primitive: import('revelryengine/gltf/gltf.js').MeshPrimitive, deindex: boolean }} options
     * @this {this & { flags: ReturnType<GLTFShader['getFlags']> }}
     */
        ...
        for(let t = 0; t < targetCount; t++) {
            ...
            for(const [name, a] of Object.entries(target)) {
                if(a && locations[name] !== undefined) {
                    const accessor = /** @type {import('revelryengine/gltf/gltf.js').Accessor} */(a);
                    /**
