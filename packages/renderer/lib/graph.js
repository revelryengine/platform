...
import { NonNull, WeakCache, roundUp } from '../deps/utils.js';
...
export class Graph {
    state = {
        nodes:       /** @type {WeakMap<import('../deps/gltf.js').Node,NodeState> } */(new WeakMap()),
     ...
     * @param {import('../deps/gltf.js').MeshPrimitive} primitive
     */
     ...
     * @param {import('../deps/gltf.js').Node} node - The node to get the state for
     */
    getNodeState(node) {
     ...
     *
     * @param {import('../deps/gltf.js').Node} node - The node to update
     */
    updateNode(node) {
     ...
     *
     * @param {Set<import('../deps/gltf.js').Node>} nodes
     * @param {import('../deps/gltf.js').Node|import('../deps/gltf.js').Scene} root
     */
    updateNodes(nodes, root = this.scene) {
        const search = [...('nodes' in root ? root.nodes : root.children)];

        while (search.length) {
            const node = /** @type {import('../deps/gltf.js').Node} */(search.shift());
            if (nodes.has(node)) {
                this.updateNode(node);
            } else {
    ...
    /**
     * @type {WeakMap<import('../deps/gltf.js').Material, Material>}
     */
    ...
    /**
     * @param {{
     *  '/nodes': Set<import('../deps/gltf.js').Node>
...
* @typedef {{ offset: number, count: number, primitive: import('../deps/gltf.js').MeshPrimitive, frontFace: 'cw'|'ccw', instances: mat4[], depth: number }} InstanceBatch
* @typedef {{ size: number, batches: InstanceBatch[], buffer: import('./revgal.js').REVBuffer, data: Uint32Array }} InstanceBlock
* @typedef {{ buffer: import('./revgal.js').REVBuffer, offset: number, primitive: import('../deps/gltf.js').MeshPrimitive, frontFace: 'cw'|'ccw' }} GameObjectInstanceBlock
*
...
* }} MeshState
* @typedef {{
*  parent:         import('../deps/gltf.js').Node|null,
*  localTransform: mat4,
*  worldTransform: mat4,
*  mesh?:          MeshState,
*  skin?:          SkinState,
