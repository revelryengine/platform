...
export class RevGAL {
     ...
     *
     * @param {{ data: import('revelryengine/utils/utils.js').TypedArray, size?: number } & Omit<GPUBufferDescriptor, 'size'>} options
     */
    createBufferWithData({ data, size, ...descriptor }) {
        ...
        const range  = new /** @type {import('revelryengine/utils/utils.js').TypedArrayConstructor} */(data.constructor)(buffer.getMappedRange());
        range.set(data);
        buffer.unmap();
        return buffer;
    }
    ...
    /**
     * @param {import('revelryengine/gltf/gltf.js').Texture} gltfTexture
     */
    ...
    /**
     * @param {import('revelryengine/gltf/gltf.js').TextureKHRTextureBasisu} basisuInfo
     * @param {boolean} sRGB
     */
