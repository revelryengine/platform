...
export class KHRLightsPunctualSpot extends GLTFProperty {
    ...
    /**
     * Creates a KHRLightsPunctualSpot instance from its JSON representation.
...
export class KHRLightsPunctualLight extends NamedGLTFProperty {
    ...
    /**
     * Creates a KHRLightsPunctualLight instance from its JSON representation.
...
export class KHRLightsPunctualGLTF extends GLTFProperty {
    ...
    /**
     * Creates a KHRLightsPunctualGLTF instance from its JSON representation.
...
export class KHRLightsPunctualNode extends GLTFProperty {
    ...
    /**
     * Creates a KHRLightsPunctualNode instance from its JSON representation.
