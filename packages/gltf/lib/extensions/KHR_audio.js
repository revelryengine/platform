 ...
 */
 export class KHRAudioPositional extends GLTFProperty {
    ...
    /**
     * Creates a KHRAudioPositional instance from its JSON representation.
...
export class KHRAudioData extends GLTFProperty {
    ...
    /**
     * Creates a KHRAudioData instance from its JSON representation.
...
export class KHRAudioSource extends GLTFProperty {
    ...
    /**
     * Creates a KHRAudioSource instance from its JSON representation.
...
export class KHRAudioEmitter extends GLTFProperty {
    ...
    /**
     * Creates a KHRAudioEmitter instance from its JSON representation.
 ...
 */
 export class KHRAudio extends GLTFProperty {
    ...
    /**
     * Creates a KHRAudio instance from its JSON representation.
...
export class KHRAudioNode extends GLTFProperty {
    ...
    /**
     * Creates a KHRAudioNode instance from its JSON representation.
...
export class KHRAudioScene extends GLTFProperty {
    ...
    /**
     * Creates a KHRAudioScene instance from its JSON representation.
