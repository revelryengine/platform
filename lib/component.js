...
export class Component extends Watchable {
    ...
    constructor(componentData) {
        ...
        if(Watchable.isWatchable(this.#value)) {
            ...
            this.#value.watch({ handler: /** @param {import('./utils/watchable.js').WatchableEventMap} events */(events) => this.notify('value:notify', events), deferred: true, signal: this.#abortCtl.signal });
        }
    }
