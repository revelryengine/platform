...
/**
 * @import { Stage, ComponentTypeKey, ComponentDataMap, ComponentDataMapSerialized, ComponentEventMap } from './ecs.js';
 */
...
export class Component extends Watchable {
    ...
    constructor(stage, componentData) {
        ...
        this.#references = (componentSchemas[type]?.hasReferences ? {} : undefined);
