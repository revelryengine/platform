...
export class Material extends NamedGLTFProperty {
    ...
    constructor(material = {}) {
         ...
         * @type {TextureInfo}
         */
        this.emissiveTexture = emissiveTexture ? new TextureInfo(emissiveTexture, false) : undefined;
    ...
    static referenceFields = [
        { name: 'pbrMetallicRoughness', type: 'sub' },
        { name: 'normalTexture',        type: 'sub' },
        { name: 'occlusionTexture',     type: 'sub' },
        { name: 'emissiveTexture',      type: 'sub', assign: { sRGB: true } },
    ];
}
