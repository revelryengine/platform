 ...
 * @template {ComponentTypesDefinition} [T = ComponentTypesDefinition]
 * @extends {GameNode<import('./game.js').Game, System<T>, SystemEvents<T> & EntityEvents<T> & ComponentEvents<T>>}
 */
export class Stage extends GameNode {
    ...
    getComponentReference(entityId, type) {
        return /** @type {ComponentReference<T, K>} */(new ComponentReference(this, entityId, type, this.#referenceCounts));
    }
