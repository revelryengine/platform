 ...
 * @typedef {new () => ComplexComponentData} Initializer
 */
...
export class Component extends Watchable {
    ...
    /**@type {import('./utils/watchable.js').WatchResult|Null} */
    #watcher = null;
            ...
            set: (newValue) => {
                ...
                if(oldvalue !== newValue) {
                    ...
                    if(Watchable.isWatchable(this.#value)) {
                        this.#watcher = this.#value.watch((_, oldValue) => this.notify(oldValue));
                    }
