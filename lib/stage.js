...
export class Component extends Watchable {
     ...
     * @param {new (...args: any[]) => any} initializer
     */
    constructor({ id, type, entityId, value }, initializer) {
        super();
        this.id       = id;
        this.type     = type;
        this.entityId = entityId;
        this.#value   = initializer ? new initializer(value): value;
...
export class Stage extends GameNode {
    ...
    #registerComponent(componentData) {       
        const component = componentData instanceof Component ? componentData : new Component(componentData, this.#initializers.get(componentData.type));
