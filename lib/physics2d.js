 ...
 *          allowSleep?:   boolean,
 *     } },
 *     collisionShapes2d:  { value: (CircleShape | BoxShape | PolygonShape)[] },
 *     jointConstraints2d: { value: (DistanceJointConstraint | RevoluteJointConstraint)[] },
...
export class WorldPhysics2dModel extends TypedModel({
    components: {
        world: { type: 'worldPhysics2d' },
    }
}) { }

export class CollisionShape2dModel extends TypedModel({
    components: {
...
export class RigidBody2dModel extends TypedModel({
    components: {
        transform:         { type: 'transform'        },
        collisionShapes2d: { type: 'collisionShapes2d' },
...
export class KinematicRigidBody2dModel extends TypedModel({
    components: {
        transform:         { type: 'transform'        },
        collisionShapes2d: { type: 'collisionShapes2d' },
        rigidBody2d:       { type: 'rigidBody2d'      },
...
export class JointConstraint2dModel extends TypedModel({
    components: {
        transform:          { type: 'transform'          },
        rigidBody2d:        { type: 'rigidBody2d'        },
    ...
    */
    ...
    /** @type {ComponentReference<'rigidBody2d'>[]} */
    #jointRefs = [];
...
const Box2DPromise = Box2DFactory();

export class Physics2dSystem extends TypedSystem({
    models: {
    ...
    #reconcileJointConstraints(Box2D, model) {
        ...
        const cache = this.#jointConstraints.ensure(model);
    ...
    #setupDebugDraw(Box2D, cameraEntityId) {
        const element = this.game.rootElement ?? document.body;
