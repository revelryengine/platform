// @ts-nocheck This fill will be deprecated
...
export class WatchedProxy {
     ...
     * @param {WatchedProxy|null} [root=null]             - This should not be set directly as it is used internally for nested properties
