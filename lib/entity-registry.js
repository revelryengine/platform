...
export class EntityRegistry {
    ...
    createComponentProxy(component) {
        ...
        return new WatchedProxy(component, (comp, propertyPath, newValue, oldValue) => {
            this.stage.dispatchEvent(new ComponentChangeEvent({ component: comp, propertyPath, newValue, oldValue }));
        });
    }
    ...
    registerComponent(component) {
        ...
        this.stage.dispatchEvent(new ComponentAddEvent({ component: proxy }));
        return proxy;
    }
    ...
    unregisterComponent(component) {
        ...
        this.stage.dispatchEvent(new ComponentDeleteEvent({ component: proxy }));
        return proxy;
    }
}
