...
/** 
 * @typedef {typeof SystemClass} SystemConstructor
 */
...
/**
 * @typedef {{[key: string]: any }} SystemModelTypes
 */

/**
 * A class that declaratively defines a system.
 * @template {SystemModelTypes} T
 * @extends {GameNode<Stage, never>}
 */
class SystemClass extends GameNode {
    models = new IdSet();

    /**
     * @typedef SystemStaticModels
     * @property {{ [Property in keyof T]: SystemModelDefinition }} models
     */
    ...
    constructor() {
        ...
        for (const [name, { isSet }] of Object.entries(/** @type {SystemStaticModels} */(/** @type {unknown} */(this.constructor)).models)) {
            if (isSet) {
    ...
    /** 
     * @type {{[key: string]: SystemModelDefinition}}
     */
    static models = {}
}

export const System = /** @type {new <T extends object>(...args: any[]) => T & SystemClass<T> } */(/** @type {unknown} */(SystemClass));
