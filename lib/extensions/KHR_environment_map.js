...
export class KHREnvironmentMapCubemap extends GLTFProperty {
    ...
    /**
     * Creates a KHREnvironmentMapCubemap instance from its JSON representation.
...
export class KHREnvironmentMapData extends NamedGLTFProperty {
    ...
    /**
     * Creates a KHREnvironmentMapData instance from its JSON representation.
...
export class KHREnvironmentMapGLTF extends GLTFProperty {
    ...
    /**
     * Creates a KHREnvironmentMapGLTF instance from its JSON representation.
...
export class KHREnvironmentMapScene extends GLTFProperty {
    ...
    /**
     * Creates a KHREnvironmentMapScene instance from its JSON representation.
